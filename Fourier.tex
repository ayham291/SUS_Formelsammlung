...
\begin{itemize}
    ...
    \]
    % Eine lineare Überlagerung von gewichteten Zeitsignalen führt zur linearen
    ...
    \]
    % Zeit- und Frequenzbereich können vertauscht werden (bis auf den Faktor $2\pi$
...
\item \textbf{Zeitskalierung}
    ...
    \]
    % Eine Stauchung der Zeitachse führt zur Dehnung der Frequenzachse.
...
\item \textbf{Frequenzskalierung}
    ...
    \]
    % Eine Stauchung der Frequenzachse führt zur Dehnung der Zeitachse.
...
\item \textbf{Zeitverschiebung}
    ...
    \]
    % Eine Verschiebung im Zeitbereich ändert nicht den Betrag des Spektrums,
...
\item \textbf{Frequenzverschiebung - Modulation}
    ...
    \]
    % Eine Verschiebung im Frequenzbereich führt zu einem Modulationsterm im
...
\item \textbf{Multiplikation - Fenstertheorem}
    ...
    \]
    % Multiplikation im Zeitbereich entspricht Faltung im Frequenzbereich (und
    % Normierung mit $2\pi$).
\item \textbf{Differentiation\\}
    ...
    \]
    % Differenzieren im Zeitbereich dreht die Phase des Spektrums um $\frac{\pi}{2}$ und
...
\item \textbf{Integration}
    ...
    \]
    % Integrieren dreht die Phase um $-\frac{\pi}{2}$, dämpft die Amplitude des
...
\item \textbf{Energieberechnung - Parseval}
    ...
    \]
    % Die Signalenergie lässt sich aus der Zeit- und Frequenzbereichsdarstellung berechnen.
\end{itemize}
\end{mdframed}
